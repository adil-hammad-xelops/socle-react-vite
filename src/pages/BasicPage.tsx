...
import { Container, Grid, Stack, Typography, Divider, Card, Button, Badge, Chip, Tooltip } from '../components/ui';
import { Star, Favorite, Mail } from '@mui/icons-material';

/**
 * Basic Elements Demo Page
 */
...
// Re-export Box from components/ui to avoid the error
